...
public class ReviewSitePopulator implements CommandLineRunner {
	...
	public void run(String...args) throws Exception {
		...
		Review mario = reviewRepo.save(new Review("Mario", "/images/super-mario-world.png", "ads;lpkufgsdalkj",sprite));
		Review samus = reviewRepo.save(new Review("Samus", "/images/super-metroid.png", "ads;lpkufgsdalkj",sprite));
		Review linkToThePast = reviewRepo.save(new Review("Link To The Past", "/images/link-to-the-past-cover.png", "ads;lpkufgsdalkj",game));
		Review superMarioWorld = reviewRepo.save(new Review("Super Mario World", "/images/super-mario-world-cover.png", "ads;lpkufgsdalkj",game));
		Review superMetroid = reviewRepo.save(new Review("Super Metroid", "/images/super-metroid-cover.png", "ads;lpkufgsdalkj",game));
